...
| `/setup-karabiner` | If user wants Caps Lock → Escape/Ctrl (recommended, optional) |
...
| `/skills-tutorial` | Interactive tutorial on how Claude Code skills work |
| `/example-greeting` | Simple example skill for demonstration |
| `/self-update` | Audit and update this repo for best practices |
...
3. Show them key commands:
   ...
   - `Ctrl+A |` - Split pane (or `Caps Lock+A |` with Karabiner)
   - `Ctrl+h/j/k/l` - Navigate
4. Remind them about `/tmux-tutorial` if they want to practice more
5. **Offer to learn about Claude Code skills:**

Say: "Now that your environment is ready, would you like to learn how Claude Code works under the hood? I can show you:"

- **`/skills-tutorial`** - See how I read and follow skill instructions in real-time
- **`/setup-claude-project`** - Set up Claude Code best practices for your projects

Ask: "Which would you like to explore? Or we can do both!"

6. **Mention repo maintenance:**

Say: "One last thing - this repo has a `/self-update` skill that can audit and update all the tools and documentation. Run it periodically to keep everything current."
